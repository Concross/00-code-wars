...
function displayPics(){
  ...
  // const declares a variable of block-level scope. In this instance, rando is given a value within the outer while loop, and has no value once outside of that loop.
  console.log(viewed);
